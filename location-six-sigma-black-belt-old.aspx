<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="location-six-sigma-black-belt-old.aspx.cs" Inherits="P3WebApp.location_sixsigma_black_old" MasterPageFile="~/Site.Master" %>
...
<h1 style="text-align:center"><%=City %> Lean Six Sigma Black Belt Class</h1>
<uc1:ClassHeader ID="ClassHeader1" ClassType="L6BI" runat="server" />
         <p>
    ...
    <p class=" style4"><b><%=City %> Lean Six Sigma Black Belt Class Location:</b></p>
    <table>
        <tr>
     ...
     <p class=" style4"><b><%=City %> Lean Six Sigma Black Belt Class Schedule</b></p>
     <br />
    ...
    <p class=" style4"><b><a href="lean-six-sigma-black-belt.aspx">Click here for our full schedule</a></b></p>
     <p>&nbsp;</p>
