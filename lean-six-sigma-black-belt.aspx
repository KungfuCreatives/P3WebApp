<%@ Page Language="C#" AutoEventWireup="true" Inherits="SixSigmaBlackBelt" Codebehind="lean-six-sigma-black-belt.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<title>Project Management Training | Six Sigma Black Belt Certification Training | Six Sigma Black Belt Training</title>
<meta name="description" content="Signup For Six Sigma Black Belt Training Here! Start Your Six Sigma Black Belt Training With Us And Save! Pinnacle 3 Learning Offers The Best Six Sigma Black Belt Training Classes Available With a 98% Pass Rate!" />
<meta name="keywords" content="Six Sigma Black Belt training, Six Sigma Black Belt certification, Six Sigma Black Belt certification training, Six Sigma Black Belt training" />
</asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
                	  <h1 style="text-align:center">Lean Six Sigma Black Belt Program</h1>
                       ...
                       The ACCELERATED LEAN SIX SIGMA BLACK BELT TRAINING PROGRAM AND METHODOLOGY© allows students to complete certification requirements faster than traditional Six Sigma and Lean training programs. We have the only nationally recognized program that has created a recognized Lean Six Sigma Body of knowledge that is based on the ASQ Six Sigma Black Belt Body of Knowledge. See the international award at <a href="http://www.lean6.org">www.lean6.org</a>.</p>
                             ...
                             <li>Phase 3 is the practical application.  Your on-line instructor will mentor you as you complete two Black Belt level projects and a Lean Six Sigma article. </li>
                             </ul>
                                ...
                                <AlternatingItemStyle CssClass="TelerikItem" />
                                    <Columns>
                                        ...
                                        <HeaderStyle Width="140px" />
                                            ...
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" Font-Size="Small" runat="server" ToolTip="More info about this city" NavigateUrl='<%#Eval("LocationSeo")+"-lean-six-sigma-black-belt-training-class" %>' Text='<%# Bind("City") %>' ></asp:HyperLink>
