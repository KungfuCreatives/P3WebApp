<%@ Page Language="C#" AutoEventWireup="true" Inherits="philosophy" Codebehind="philosophy.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
     <uc1:CmsPageContent ID="CmsPageContent1" runat="server" PageTitle="P3 Philosophy" />
</asp:Content>