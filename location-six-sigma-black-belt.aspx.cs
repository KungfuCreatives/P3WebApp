...
namespace P3WebApp
{
    public partial class location_sixsigma_black : System.Web.UI.Page
    {
        public string City;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CmsLocationContent.PageTitle = City + " L6Black";
            ...
            m.DataBindBreadCrumbSiteMap(newMenuItem, "l6bi");
        ...
        {
            return DisplayHelper.GetPriceText(classDate, ClassType.SixSigmaBlackBelt);
        }
        protected int GetPrice(DateTime classDate)
        {
            int cost = DisplayHelper.GetPrice(classDate, ClassType.SixSigmaBlackBelt);
            if (classCost < cost)
                classCost = cost;
            return cost;
        }
