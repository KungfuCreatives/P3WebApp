...
public partial class SixSigmaGreenBelt : System.Web.UI.Page
{
    ...
    {
        return P3WebApp.DisplayHelper.GetPriceText(classDate, P3WebApp.ClassType.SixSigmaGreenBelt);
    }
    protected int GetPrice(DateTime classDate)
    {
        return P3WebApp.DisplayHelper.GetPrice(classDate, P3WebApp.ClassType.SixSigmaGreenBelt);
    }
