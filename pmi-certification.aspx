<%@ Page Language="C#" AutoEventWireup="true" Inherits="pmicertification" Codebehind="pmi-certification.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
     <uc1:CmsPageContent ID="CmsPageContent1" runat="server" PageTitle="P3 PMI Certification" />
</asp:Content>