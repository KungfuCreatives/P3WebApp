<%@ Page Language="C#" AutoEventWireup="true" Inherits="ProjectManagementCourses" Codebehind="project-management-courses.aspx.cs" MasterPageFile="~/Site.Master" %>
<asp:Content runat="server" ContentPlaceHolderID="MetaContent" ID="contentMeta">
<title>Project Management Courses | PMP Course | Project Management Classes</title>
<meta name="description" content="Project Management Courses Designed To See YOU Succeed! View Our Available Project Management Classes and Get Started Today. Join Your Local PMP Course Here!" />
<meta name="keywords" content="project management courses, project management course, project management classes, pmp courses, pmp classes, pmp course" /></asp:Content>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
                    	...
                    	<p class="classTitle2"><a href="Instructor_Led_PMP_Exam_Training.aspx">Instructor Led Training</a> ><a href="pmp-certification-training.aspx"> PMP Certification Exam Prep</a> > Weekday Courses</p>
                   	  <p><img src="images/2_p2.jpg" alt="PMP Exam Prep Class" width="111" height="69" />This class provides intense, focused training and is designed for the student to Pass 
                    	  the PMP exam  immediately following class. Our PMP Certified 
                   	  Instructors are well versed in the latest Adult learning concepts.</p>
                    	<p class=" style3"><b>The Project Management Professional ® Exam Prep course includes:</b></p>
                    	<ul>
                        ...
                        <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="false" Skin="Web20" DataSourceID="classDB"
                                ...
                                <AlternatingItemStyle CssClass="TelerikItem" />
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="City, State" SortExpression="City" >
                                            ...
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLink1" Font-Size="Small" Target="_blank" runat="server" ToolTip="More info about this city" NavigateUrl='<%#Eval("LocationSeo")+"-pmp-training-class" %>' Text='<%# Bind("City") %>' ></asp:HyperLink>
                            ...
                            AND Format(classes.ClassDate,&quot;mmm&quot;) =  iif(@Date='[All]',Format(classes.ClassDate,&quot;mmm&quot;),@Date)
                            ...
                            <%-- <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
                                AutoGenerateColumns="False" DataSourceID="classDB" CssClass="" 
