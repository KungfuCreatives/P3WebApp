...
namespace P3WebApp
{
    public partial class location_sixsigma_black_old : System.Web.UI.Page
    {
        public string City;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var curItem = m.RadMenu.FindItemByText("Lean Six Sigma Black Belt");
        ...
        {
            string pmpCost = ConfigurationManager.AppSettings["Cost_L6BI"];
            string pmpCostSale = ConfigurationManager.AppSettings["Cost_L6BI_Sale"];
