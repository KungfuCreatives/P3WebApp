<%@ Page Language="C#" AutoEventWireup="true" Inherits="practiceexams" Codebehind="practice-exams.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<uc1:CmsPageContent ID="CmsPageContent1" runat="server" PageTitle="P3 Practice Exams" />
</asp:Content>