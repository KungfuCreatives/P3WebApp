<%@ Page Language="C#" AutoEventWireup="true" Inherits="aboutPinnacle3Learning" Codebehind="aboutPinnacle3Learning.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
     <uc1:CmsPageContent ID="CmsPageContent1" runat="server" PageTitle="P3 About Us" />
</asp:Content>