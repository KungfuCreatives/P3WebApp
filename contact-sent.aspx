<%@ Page Language="C#" AutoEventWireup="true" Inherits="contact_sent" Codebehind="contact-sent.aspx.cs"  MasterPageFile="~/Site.Master" %>
<asp:Content runat="server" ContentPlaceHolderID="MetaContent" ID="contentMeta">
<title>PMP Certification - Thank You For Contacting Us!</title>
...
<p class=", style4">
<font color="red"><b>Thank you for inquiring! A Pinnacle 3 Learning representative will
    contact you shortly! We look forward to the opportunity to help you achieve your goals.</b></font>
    </p>
    ...
    var google_conversion_label = "3QpsCL-dwQIQsbuB-QM";
    ...
    <img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1059085745/?label=3QpsCL-dwQIQsbuB-QM&amp;guid=ON&amp;script=0"/>
    </div>
    </noscript>  
    ...
    <script id="mstag_tops" type="text/javascript" src="//flex.atdmt.com/mstag/site/b1a48539-ddf1-47a1-8afa-4a084259a795/mstag.js"></script> 
    <script type="text/javascript">
