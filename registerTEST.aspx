<%@ Page Language="C#" AutoEventWireup="true" Inherits="registerTEST" Codebehind="registerTEST.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
                    	<p class="pPad"><img src="images/title_register.gif" alt="Pinnacle 3 Learning - PMP Certification Training"></p>
                    	&nbsp;<br />
                                    ...
                                    <table cellpadding="2" cellspacing="0" border="1" width="520" align="center">
                                        ...
                                        <tr>
                                            <td colspan="2" align="center"><asp:Button ID="nextStep" runat="server" 
                                                    Text="Next Step >>" onclick="nextStep_Click" /></td>
                                        </tr>
                                    </table>
