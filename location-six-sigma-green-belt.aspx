<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="location-six-sigma-green-belt.aspx.cs" Inherits="P3WebApp.location_sixsigma_green" MasterPageFile="~/Location.Master" %>
...
<link rel="canonical" href="http://www.pinnacle3learning.com/<%# LocationSeo %>-lean-six-sigma-green-belt-training-class"/>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
    <asp:Panel runat="server" ID="pnlStaticDetails">
        <uc1:CmsPageContent ID="CmsPageContent1" runat="server" PageTitle="P3 Location Page: Lean Six Sigma Green Belt" />
    </asp:Panel> 
...
<uc1:ClassHeader ID="ClassHeader1" ClassType="L6GI" ShowImage="false" runat="server" />
<fieldset class="locationSchedule wrapper">
<h1><%# City %></h1>
<h4>Lean Six Sigma Green Belt Class</h4>
