<%@ Page Language="C#" AutoEventWireup="true" Inherits="instructors" Codebehind="instructors.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
     <uc1:CmsPageContent ID="CmsPageContent1" runat="server" PageTitle="P3 Instructors" />
</asp:Content>