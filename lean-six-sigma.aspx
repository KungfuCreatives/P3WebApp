<%@ Page Language="C#" AutoEventWireup="true" Inherits="leansixsigma" Codebehind="lean-six-sigma.aspx.cs" MasterPageFile="~/Site.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="MainContent" ID="contentMain">
     <uc1:CmsPageContent ID="CmsPageContent1" runat="server" PageTitle="P3 Lean Six Sigma" />
</asp:Content>