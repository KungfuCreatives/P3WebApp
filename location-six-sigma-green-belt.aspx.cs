...
namespace P3WebApp
{
    public partial class location_sixsigma_green : System.Web.UI.Page
    {
        public string City;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CmsLocationContent.PageTitle = City + " L6Green";
        ...
        {
            return DisplayHelper.GetPriceText(classDate, ClassType.SixSigmaGreenBelt);
        }
        protected int GetPrice(DateTime classDate)
        {
            int cost = DisplayHelper.GetPrice(classDate, ClassType.SixSigmaGreenBelt);
            if (classCost < cost)
                classCost = cost;
            return cost;
        }
