<%@ Page language="c#" Codebehind="status_ls2.aspx.cs" AutoEventWireup="false" Inherits="LinkPointAPI_cs.status_ls2" %>
...
%>
	...
	<body MS_POSITIONING="GridLayout">
		<p align="left"><b><font size="4">&nbsp;PREAUTH TRANSACTION RESULT</font></b><br>
			<div align="center">
		...
		<p align="left"><b><font size="4">&nbsp;SCORING RESULT :</font></b>
			...
			Response.Write("<p align='left'><b><font size='3'>&nbsp;The POSTAUTH transaction was not performed because of scoring result</font></b>");
			} else {
		ParseResponse(resp_2);
		%>
		<p align="left"><b><font size="4">&nbsp;POSTAUTH TRANSACTION RESULT</font></b><br>
			<div align="center">
				<table border="1" cellpadding="0" cellspacing="0">
					<tr>
						<td width="279" bgcolor="#c0c0c0" style="WIDTH: 279px">&nbsp;SSL API Version:</td>
