<%@ Page language="c#" Codebehind="LINKSHIELD_SALE_VOID.aspx.cs" AutoEventWireup="false" Inherits="LinkPointAPI_cs.LINKSHIELD_SALE_VOID" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" action="LINKSHIELD_SALE_VOID.aspx" method="post" runat="server">
			<p align="center"><b><font size="5">&nbsp;LinkShield SALE TRANSACTION</font></b></p>
			<p align="center">An Example Credit Card SALE with score rating (LinkShield). This 
				sample first performs a credit card sale,then checks the LinkShield risk score. 
				If the score is more then given threshold then we void the previous sale 
				transaction
			</p>
			...
			<div align="center">
				<TABLE id="TABLE1" style="WIDTH: 356px; HEIGHT: 238px" height="238" cellSpacing="0" cellPadding="0" width="356" bgColor="#c0c0c0" border="0">
					...
					<TR>
						...
						<TD width="276" height="1">Order Type:</TD>
						<TD style="WIDTH: 15px" width="15" height="1">&nbsp;</TD>
						<TD style="BORDER-RIGHT-STYLE: solid" width="78" height="1"><b>SALE</b></TD>
					</TR>
					<TR>
