<%@ Page language="c#" Codebehind="PREAUTH.aspx.cs" AutoEventWireup="false" Inherits="LinkPointAPI_cs.PREAUTH" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form ACTION="PREAUTH.aspx" METHOD="post" NAME="SaleForm" runat="server" ID="Form1">
			<p align="center"><b><font size="5">&nbsp;CREDIT CARD PREAUTH TRANSACTION</font></b><br>
			</p>
			<p align="center">An Example Credit Card PreAuth Transaction with Minimum Required 
				Fields</p>
			<div align="center">
				<center>
					<TABLE id="TABLE1" cellSpacing="0" cellPadding="0" width="356" border="0" height="238" bgcolor="#c0c0c0" style="WIDTH: 356px; HEIGHT: 238px">
						...
						<TR>
							...
							<TD height="1" width="78" style="BORDER-RIGHT-STYLE: solid"><b>PREAUTH</b></TD>
						<TR>
							<TD height="1" width="103" style="WIDTH: 103px;  BORDER-LEFT-STYLE: solid">&nbsp;</TD>
