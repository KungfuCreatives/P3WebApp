<%@ Page language="c#" Codebehind="PB_CANCEL.aspx.cs" AutoEventWireup="false" Inherits="LinkPointAPI_cs.PB_CANCEL" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>PB_CANCEL</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form ACTION="PB_CANCEL.aspx" METHOD="post" NAME="SaleForm" runat="server" ID="Form1">
			<p align="center"><b><font size="5">&nbsp;PERIODIC BILLING (CANCEL)</font></b><br>
			</p>
			<p align="center">An Example of Periodic Billing Cancel Transaction with Minimum 
				Required Fields</p>
			<div align="center">
				<center>
...
-->
						...
						<TR>
							...
							<TD height="1" width="115" style="WIDTH: 115px"></TD>
							<TD height="1" width="249" style="WIDTH: 249px; BORDER-RIGHT-STYLE: solid"><b>CANCEL</b></TD>
						</TR>
						<TR>
							<TD height="1" width="30" style="WIDTH: 30px; BORDER-LEFT-STYLE: solid">&nbsp;</TD>
			...
			<P align="left"><FONT color="red">*</FONT>) You MUST pass a valid Order ID for an 
				EXISTING periodic bill to identify which bill you want to modify.
			</P>
		</form>
	</body>
</HTML>
