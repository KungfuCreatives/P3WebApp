...
namespace LinkPointAPI_cs
{
	...
	/// </summary>
	public class LINKSHIELD_PREAUTH_POSTAUTH : LinkPointTxn_Page
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			bool fDoPostAuth = false;
			string scoreMsg="";			
			...
			if( IsPostBack )
			{
				...
				// if we got acceptable score 
				// we run POSTAUTH transaction
				if( fDoPostAuth )
				{
				ProcessPostAuth();
				}
			...
			// go to status page
			Server.Transfer("status_ls2.aspx");	
